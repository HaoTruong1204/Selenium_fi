from PyQt5.QtWidgets import QWidget, QLabel, QVBoxLayout, QTextEdit, QPushButton, QHBoxLayout, QComboBox
...
class LogsWidget(QWidget):
    ...
    def apply_theme(self):
        ...
        try:
            ...
            print(f"Lỗi khi áp dụng theme cho LogsWidget: {e}")
            traceback.print_exc()
